                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" name="mobile" class="form-control" id="mobile"
                                    placeholder="Enter mobile" value="{{$admin->user->mobile}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group clearfix">
                                    <div class="icheck-primary d-inline">
                                        <input type="radio" id="male" name="gender" @if($admin->user->gender == 'M')
                                        checked
                                        @endif>
                                        <label for="male">
                                            Male
                                    ...
                                    <div class="icheck-primary d-inline">
                                        <input type="radio" id="female" name="gender" @if($admin->user->gender == 'F')
                                        checked
                                        @endif>
                                        <label for="female">
                                            Female
