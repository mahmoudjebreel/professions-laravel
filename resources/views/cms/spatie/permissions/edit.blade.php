...
@section('small-title','Permissions')
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control guards" style="width: 100%;" id="guards">
                                    <option value="web" @if($permission->guard_name == 'web') selected @endif>Admin
                                    </option>
                                    <option value="professional" @if($permission->guard_name == 'professional') selected
                                        @endif>Professional
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="name"
                                    placeholder="Enter role name" value="{{$permission->name}}">
                            </div>
                        </div>
                        <!-- /.card-body -->
