...
<head>
  ...
  <title>Profession System CMS | @yield('title')</title>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            @canany(['Create-Roles','Index-Roles','Create-Permissions','Index-Permissions'])
            <li class="nav-header">Roles & Permissions</li>
            @canany(['Create-Roles','Index-Roles'])
            <li class="nav-item">
              <a href="#" class="nav-link">
            ...
            @endcanany
            @canany(['Create-Permissions','Index-Permissions'])
            <li class="nav-item">
              <a href="#" class="nav-link">
            ...
            @canany(['Create-Admin','Index-Admin','Create-Professional','Index-Professional','Create-Customer','Index-Customer'])
            <li class="nav-header">Human Resources</li>
            @canany(['Create-Admin','Index-Admin'])
            <li class="nav-item">
              <a href="#" class="nav-link">
            ...
            @endcanany
            @canany(['Create-Professional','Index-Professional'])
            <li class="nav-item">
              <a href="#" class="nav-link">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{route('professionals.create')}}" class="nav-link">
                    <i class="fas fa-plus-square nav-icon"></i>
                    <p>Create</p>
                  </a>
                </li>
            ...
            @endcanany
            @canany(['Create-Customer','Index-Customer'])
            <li class="nav-item">
              <a href="#" class="nav-link">
            ...
            @canany(['Create-Cities','Index-Cities','Create-Specialities','Index-Specialities','Create-Professions','Index-Professions'])
            <li class="nav-header">Content Management</li>
            @canany(['Create-Cities','Index-Cities'])
            <li class="nav-item">
              <a href="#" class="nav-link">
            ...
            @endcanany
            @canany(['Create-Specialities','Index-Specialities'])
            <li class="nav-item">
              <a href="#" class="nav-link">
            ...
            @endcanany
            @canany(['Create-Professions','Index-Professions'])
            <li class="nav-item">
              <a href="#" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{route('cms.auth.edit-password')}}" class="nav-link">
